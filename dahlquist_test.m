function error_matrix = dahlquist_test(x_0, t_end, dt_vector,f, f_sol)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%       f_sol       - function representing the analytical solution.
...
figure(1)
plot(x_vector, f_sol(x_vector), 'k');
...
for i = 1:length(dt_vector)
    ...
    %errors for heun are stored in the second row
    ...
    %errors for rk4 are stored in the third row
